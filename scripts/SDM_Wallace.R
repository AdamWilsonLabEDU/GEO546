...
#' <br>
#' 
#' ![](SDM_assets/Wallace8b.png)
#' 
#' 
#' <br>
#' 
#' ![](SDM_assets/Wallace8c.png)
#' 
#' 
#' <br>
#' 
#' ![](SDM_assets/Wallace8d.png)
#' 
#' <br>
#' 
#' # Extracting the code
...
#' <br>
#' 
#' Now, you should have an .Rmd file that contains your complete analysis. Sometimes, if you make a bunch of mistakes while playing with the GUI, you might get an error when extracting the .Rmd. If that happens, you can download mine [here](https://cmerow.github.io/RDataScience/SDM_assets/Outputs/wallace-session-2017-01-26.Rmd)
#' 
...
#' 
#' If you use RStudio, you can open this Rmd an click to **knit** to compile your workflow into a sharable html document. Just in case you encountered an error, you can see mine [here](https://cmerow.github.io/RDataScience/SDM_assets/Outputs/wallace-session-2017-01-26.html)
#' 
