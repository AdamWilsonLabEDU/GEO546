...
#' To evaluate whether the model makes biological sense, we can look at climatic envelopes that define the estimated 'hyperdimensional' niche. Bioclim does not seem to do a great job at uniquely identifying the appropriate ranges of each variable (note that the ) Note that the units are degrees C x 100; worldclim serves the files this way to compress them.)
#' 
#' 
#' <div class="well">
#' ## BIOCLIM variables
